...
BOARD_KERNEL_CMDLINE := console=null androidboot.hardware=qcom user_debug=31 androidboot.selinux=permissive msm_rtb.filter=0x3F androidboot.bootdevice=msm_sdcc.1
